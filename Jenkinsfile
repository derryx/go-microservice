    ...
    stages {
      stage('CI Build and push snapshot') {
        ...
        steps {
          ...
          dir ('/home/jenkins/go/src/github.com/derryx/go-microservice/charts/preview') {
            container('go') {
              sh "make preview"
      ...
      stage('Build Release') {
        ...
        steps {
          container('go') {
            ...
            dir ('/home/jenkins/go/src/github.com/derryx/go-microservice/charts/go-microservice') {
